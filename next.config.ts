        ...
        headers: [
          ...
          ] : []),
          {
            ...
            value: [
              ...
              "media-src 'self' https://typefive.b-cdn.net https:",
              "font-src 'self' data:",
              "connect-src 'self' https://*.openstreetmap.org https://*.tile.openstreetmap.org https://api.stripe.com https://checkout.stripe.com https://typefive.b-cdn.net",
