...
export default function GlobalError({
  ...
  return (
    <html lang="ar" dir="rtl">
      ...
      <body className="--font-ibm-plex-arabic --font-jakarta antialiased bg-background text-foreground font-[family-name:var(--font-ibm-plex-arabic)] min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 p-4">
