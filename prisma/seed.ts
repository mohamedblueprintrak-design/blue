...
async function main() {
  ...
  const project2 = await db.project.create({ data: { number: 'PRJ-2024-002', name: 'مبنى سكني متعدد الطوابق', nameEn: 'Residential Building', clientId: client2.id, contractorId: contractor2.id, location: 'أبو ظبي', type: 'building', status: 'active', progress: 40, budget: 850000, startDate: new Date('2024-03-01'), endDate: new Date('2025-06-30'), description: 'مبنى سكني 12 طابق', createdById: pmUser.id } });
